...
public class MarkdownParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("Markdown");
  ...
  { 
    MarkdownParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = MarkdownParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = MarkdownParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(MarkdownParseControllerGenerated.class);
    }
  ...
  { 
    return MarkdownParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
